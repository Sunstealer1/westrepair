...
def main():
    ...
    if unsafe():
        error_msg = "One or more debrid services are not working properly. Skipping repair."
                    ...
                    if args.mode == 'symlink':
                        ...
                        if os.path.islink(fullPath):
                            ...
                            if ((realdebrid['enabled'] and destinationPath.startswith(realdebrid['mountTorrentsPath']) and not os.path.exists(destinationPath)) or 
                               (torbox['enabled'] and destinationPath.startswith(torbox['mountTorrentsPath']) and not os.path.exists(os.path.realpath(fullPath))) or
